...
import { updateDataImpact, bodyParser } from './db';
...
export default async function (req, res) {
    if (req.method === 'POST') {
      try {
        ...
        const result = await updateDataImpact(bodyPayload['ip'], bodyPayload['duration'], bodyPayload['sessionid']); // Insert into database
